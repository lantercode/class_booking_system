...
export { courseApi, courseTypeApi, courseCategoryApi } from './courses'
export type {
  Course,
  CourseType,
  CourseCategory,
  ...
  CourseCategoryCreateParams,
  CourseCategoryUpdateParams,
} from './courses'
...
export type { UploadImageResponse } from './common'
