...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        "audit_logs",
        ["tenant_id", "user_id", sa.literal_column("created_at DESC")],
        unique=False,
    )
    op.create_table(
        "permissions",
    ...
    op.create_index(
        "idx_courses_tenant_category", "courses", ["tenant_id", "category"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "roles",
        [sa.literal_column("COALESCE(tenant_id, 0)"), "code"],
        unique=True,
    )
    op.create_table(
        "users",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "booked_count <= capacity AND booked_count >= 0", name="chk_schedule_capacity"
        ),
    ...
    op.create_index(
        "idx_schedules_classroom_start",
        "course_schedules",
        ["tenant_id", "classroom_id", "start_at"],
        unique=False,
    )
    op.create_index("idx_schedules_course", "course_schedules", ["course_id"], unique=False)
    op.create_index(
        "idx_schedules_teacher_start",
        "course_schedules",
        ["tenant_id", "teacher_id", "start_at"],
        unique=False,
    )
    op.create_index(
        "idx_schedules_tenant_start", "course_schedules", ["tenant_id", "start_at"], unique=False
    )
    op.create_index(
        op.f("ix_course_schedules_tenant_id"), "course_schedules", ["tenant_id"], unique=False
    )
    op.create_table(
        "membership_cards",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        "idx_cards_student", "membership_cards", ["tenant_id", "student_id", "status"], unique=False
    )
    op.create_index(
        op.f("ix_membership_cards_tenant_id"), "membership_cards", ["tenant_id"], unique=False
    )
    op.create_table(
        "orders",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        ...
        "orders",
        ["tenant_id", "status", sa.literal_column("created_at DESC")],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_student_profiles_tenant_id"), "student_profiles", ["tenant_id"], unique=False
    )
    op.create_table(
        "teacher_profiles",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        "idx_teacher_profiles_tenant", "teacher_profiles", ["tenant_id", "status"], unique=False
    )
    op.create_index(
        op.f("ix_teacher_profiles_tenant_id"), "teacher_profiles", ["tenant_id"], unique=False
    )
    op.create_table(
        "user_roles",
        sa.Column("user_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["membership_card_id"], ["membership_cards.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        "idx_bookings_schedule", "bookings", ["tenant_id", "schedule_id", "status"], unique=False
    )
    op.create_index(
        "idx_bookings_student", "bookings", ["tenant_id", "student_id", "status"], unique=False
    )
    ...
    op.create_index(
        ...
        unique=True,
        postgresql_where=sa.text("status IN (1, 3, 4)"),
    )
    op.create_table(
        "payments",
        sa.Column("id", sa.BigInteger(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "uq_users_tenant_phone", table_name="users", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "uq_users_tenant_email",
        table_name="users",
