...
down_revision: Union[str, Sequence[str], None] = 'c17b284c3335'
...
def upgrade() -> None:
    ...
    op.add_column('membership_card_products', sa.Column('applicable_course_type_code', sa.String(50), nullable=True, comment='适用的课程类型代码（单选），NULL表示不限'))
    ...
    op.add_column('membership_cards', sa.Column('applicable_course_type_code', sa.String(50), nullable=True, comment='适用的课程类型代码（从产品继承，单选）'))
...
def downgrade() -> None:
    ...
    op.add_column('membership_cards', sa.Column('applicable_course_type_codes', sa.ARRAY(sa.String(50)), nullable=True, comment='适用的课程类型代码列表（从产品继承）'))
    ...
    op.add_column('membership_card_products', sa.Column('applicable_course_type_codes', sa.ARRAY(sa.String(50)), nullable=True, comment='适用的课程类型代码列表，NULL表示不限'))
